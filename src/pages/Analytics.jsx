  ...
  return (
    <div className="space-y-6">
      <div className="rounded-3xl border border-white/50 bg-white/80 p-5 shadow-sm backdrop-blur dark:border-ink-700 dark:bg-ink-900/60">
        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-clay-500">{t('analytics.title')}</p>
        <h1 className="mt-2 text-2xl font-bold">{t('analytics.title')}</h1>
        <p className="mt-2 max-w-2xl text-sm text-ink-500 dark:text-ink-300">{t('analytics.subtitle')}</p>
      </div>

      <div className="card p-5">
        <h2 className="mb-4 text-sm font-semibold text-ink-500">{t('analytics.usageOverTime')}</h2>
      ...
      <div className="card p-5">
        <h2 className="mb-4 text-sm font-semibold text-ink-500">{t('analytics.topMaterials')}</h2>
